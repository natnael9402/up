...
exports.logger = exports.sanitizeForLogging = void 0;
...
const shouldLog = (level) => levelsPriority[level] >= levelsPriority[currentLevel];
    ...
    if (typeof meta === "object") {
        return Object.entries(meta).reduce((acc, [key, value]) => {
            if (SENSITIVE_FIELDS.has(key.toLowerCase())) {
                ...
                acc[key] = (0, exports.sanitizeForLogging)(value);
            }
            return acc;
        }, {});
    }
